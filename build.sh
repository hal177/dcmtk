...
cd $build_path
cmake $script_dir -DBUILD_SHARED_LIBS=TRUE -DCMTK_DEFAULT_DICT="builtin" -DDCMTK_ENABLE_CXX11=TRUE -DDCMTK_ENABLE_STL=TRUE -DCMAKE_INSTALL_PREFIX=$install_path
echo "Calling cmake build"
cmake --build . -j$(( $(nproc --all) - 4 ))
make install
